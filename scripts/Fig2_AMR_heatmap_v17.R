...
st_counts <- c(ST258=9, ST11=21, ST512=6, ST65=9, ST23=76, ST86=22, ST29=8)
...
png(file.path(OUT,"Fig2_AMR_heatmap_v17.png"),
...
draw(ht, merge_legend=TRUE,
     annotation_legend_list = list(
       Legend(title = "Gene annotation",
              ...
              title_gp = gpar(fontsize=18, fontface="bold"),
              labels_gp = gpar(fontsize=16))),
     padding=unit(c(20,12,8,8),"mm"),
     background="white")
dev.off()

pdf(file.path(OUT,"Fig2_AMR_heatmap_v17.pdf"), width=26, height=fig_height)
draw(ht, merge_legend=TRUE,
     annotation_legend_list = list(
       Legend(title = "Gene annotation",
              labels = c("* chromosomal gene", "+ point mutation"),
