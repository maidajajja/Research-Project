...
# Paul Tol muted palette - colourblind friendly, muted
class_colours <- c(
...
# Muted ST colours - Paul Tol bright palette muted
st_cols <- setNames(c(
  "#332288","#117733","#44AA99","#88CCEE",
  "#DDCC77","#CC6677","#AA4499","#BBBBBB"),
  st_levels)

# Muted Host Health colours
hh_cols <- c(
  "Liver abscess"            = "#CC6677",
  "Liver transplant"         = "#88CCEE",
  "Other liver disease"      = "#44AA99",
  "Non-liver or unspecified" = "#DDCC77",
  "Unknown"                  = "#DDDDDD"
)
