...
# pick top 7 most prevalent STs, ordered by mean gene count ascending
...
top_sts_asc <- st_mean_filtered$ST  # ascending mean gene count order

# Fixed ST colours consistent across figures
...
dev.off()
message("Fig2 v4 saved at 600 DPI")
# colour fix applied in v4
