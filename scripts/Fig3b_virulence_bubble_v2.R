...
# Remove zero prevalence rows for cleaner plot
...
p <- ggplot(plot_df_nonzero, aes(x=Locus, y=ST)) +
  # Single circle — size=prevalence, fill=% intact
...
ggsave(file.path(OUT,"Fig3b_virulence_bubble_v2.png"),
       p, width=8, height=5, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig3b_virulence_bubble_v2.pdf"),
       p, width=8, height=5)

message("Fig3b v2 saved")
