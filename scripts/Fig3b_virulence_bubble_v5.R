...
verified_n <- c(ST23=76, ST11=21, ST65=9, ST86=22, ST29=8, ST258=9, ST512=6)
  st_labels_vec <- paste0(names(verified_n), " (n=", verified_n, ")")
  names(st_labels_vec) <- names(verified_n)
...
ggsave(file.path(OUT,"Fig3b_virulence_bubble_v5.png"),
       p, width=9, height=5.5, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig3b_virulence_bubble_v5.pdf"),
