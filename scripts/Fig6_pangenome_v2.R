...
ggsave(file.path(OUT,"Fig6a_pangenome_composition_v2.png"),
       fig6a, width=8, height=6, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig6a_pangenome_composition_v2.pdf"),
       fig6a, width=8, height=6)

ggsave(file.path(OUT,"Fig6b_pangenome_frequency_v2.png"),
       fig6b, width=9, height=6, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig6b_pangenome_frequency_v2.pdf"),
       fig6b, width=9, height=6)

ggsave(file.path(OUT,"Fig6d_pangenome_accumulation.png"),
       fig6c, width=9, height=6, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig6d_pangenome_accumulation.pdf"),
