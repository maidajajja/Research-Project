...
# Clean white to dark blue colour scale
ani_cols <- colorRampPalette(c("#FFFFFF","#DEEBF7","#9ECAE1","#3182BD","#08306B"))(100)

png(file.path(OUT,"FigS2_FastANI_heatmap_v2.png"), width=14, height=12, units="in", res=300, bg="white")
...
pdf(file.path(OUT,"FigS2_FastANI_heatmap_v2.pdf"), width=14, height=12)
pheatmap(mat, color=ani_cols, annotation_row=ann_row, annotation_col=ann_row,
         annotation_colors=ann_colors, show_rownames=FALSE, show_colnames=FALSE,
         clustering_method="ward.D2", border_color=NA,
         main="K. pneumoniae Pairwise Average Nucleotide Identity (n = 234)",
