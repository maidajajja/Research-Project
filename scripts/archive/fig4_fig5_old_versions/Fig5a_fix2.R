...
# Spread 2021/2022 by nudging to numeric positions with more gap
year_map <- sort(unique(st_year$Year))
# assign evenly spaced positions but give extra gap between 2017 and 2021/2022
pos <- c(1, 2, 3, 5, 6.5)  # 2007, 2009, 2017, 2021, 2022
