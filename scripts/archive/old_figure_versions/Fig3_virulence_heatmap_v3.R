...
right_ann <- rowAnnotation(
  ...
  annotation_legend_param = list(
    ...
    labels = c("hvKP (score>=4)","Non-hvKP")))
...
png(file.path(OUT,"Fig3_virulence_heatmap_v3.png"),
    width=10, height=fig_height, units="in", res=300)
draw(ht,
     merge_legend=TRUE,
...
pdf(file.path(OUT,"Fig3_virulence_heatmap_v3.pdf"), width=10, height=fig_height)
