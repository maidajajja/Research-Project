...
png(file.path(OUT,"Fig3_virulence_heatmap_v4.png"),
    width=22, height=fig_height, units="in", res=300)
draw(ht,
     merge_legend=TRUE,
     padding=unit(c(10,20,30,15),"mm"),
     background="white")
dev.off()

pdf(file.path(OUT,"Fig3_virulence_heatmap_v4.pdf"), width=22, height=fig_height)
draw(ht, merge_legend=TRUE, padding=unit(c(10,20,30,15),"mm"))
dev.off()
