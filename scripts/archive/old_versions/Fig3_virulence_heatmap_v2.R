...
top_sts_asc <- tail(st_order, 7)  # keep top 7 most common, in ascending order
top_sts_asc <- st_order[st_order %in% tail(st_order, 7)]
...
# within each ST: ascending gene count
...
message("Fig3 v2 saved at 600 DPI")
