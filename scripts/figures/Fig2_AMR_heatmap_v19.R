...
png(file.path(OUT,"Fig2_AMR_heatmap_v19.png"),
    width=18, height=fig_height, units="in", res=300)
draw(ht,
     merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right",
     annotation_legend_list = list(gene_annotation_legend),
     padding = unit(c(20, 20, 35, 20), "mm"),
     background = "white")
dev.off()

pdf(file.path(OUT,"Fig2_AMR_heatmap_v19.pdf"),
    width=18, height=fig_height)
draw(ht,
     merge_legend = TRUE, heatmap_legend_side = "right", annotation_legend_side = "right",
     annotation_legend_list = list(gene_annotation_legend),
     padding = unit(c(20, 20, 35, 20), "mm"))
