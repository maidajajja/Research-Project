...
verified_n <- c("23"=76, "11"=21, "86"=22, "258"=9, "65"=9, "29"=8, "512"=6)
  st_labels_n <- setNames(paste0("ST", names(verified_n), " (n=", verified_n, ")"),
...
fig4a <- ggplot(st_rep %>% filter(Prevalence > 0),
  ...
  geom_col(position=position_dodge2(width=0.9, preserve="single"), width=0.9, colour="white", linewidth=0.2) +
  geom_text(aes(label=paste0(Prevalence,"%")),
            position=position_dodge2(width=0.9, preserve="single"),
            hjust=-0.1, size=4.5, colour="grey30") +
...
ggsave(file.path(OUT,"Fig4a_plasmid_replicons_v5.png"),
       fig4a, width=12, height=7, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig4a_plasmid_replicons_v5.pdf"),
...
ggsave(file.path(OUT,"Fig4b_IncHI1B_convergence_v5.png"),
       fig4b, width=7, height=6, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig4b_IncHI1B_convergence_v5.pdf"),
