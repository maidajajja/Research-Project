...
fig7 <- ggplot() +
  ...
  scale_size_area(max_size=18, name="No. isolates",
                  ...
                  guide=guide_legend(override.aes=list(shape=21, fill="grey60", colour="grey40"))) +
...
ggsave(file.path(OUT,"Fig7_convergence_v3.png"), fig7,
       width=10, height=8, dpi=300, bg="white")
ggsave(file.path(OUT,"Fig7_convergence_v3.pdf"), fig7,
       width=10, height=8)
message("Fig7 v3 saved")
